...
(function () {
    ...
    const flatpickrDate = document.querySelector('#flatpickr-date'),
        ...
        flatpickrMulti = document.querySelector('#customDates'),
    ...
    if (flatpickrMulti) {
        flatpickrMulti.flatpickr({
            mode: 'multiple',       // pick lots of dates
            minDate: 'today',          // no past picks
            dateFormat: 'Y-m-d',          // how it’s POSTed
            altInput: true,             // nicer display field
            altFormat: 'F j, Y',         // e.g. “April 23, 2025”
            // weekNumbers: true,         // optional: show week numbers
            // enableTime: true,          // remove if you don’t want times
            appendTo: document.querySelector('#assign_shift_modal .modal-body')
        });
    }
...
$(function () {
    ...
    if (bsDatepickerMultidate.length) {
        bsDatepickerMultidate.datepicker({
            format: 'yyyy-mm-dd',        // submit as ISO dates
            multidate: true,             // allow picking multiple
            multidateSeparator: ', ',    // comma + space
            todayHighlight: true,
            clearBtn: true,              // “Clear” button
            autoclose: false             // keep open to pick more
        });
    }
