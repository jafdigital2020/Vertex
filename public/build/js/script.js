...
jQuery(function () {
    // store the instance in a global var
    window.employeeDualList = jQuery('#customleave_select').bootstrapDualListbox({
        ...
        buttonText: {
            moveAll: '<i class="fa fa-forward"></i>',
            moveSelected: '<i class="fa fa-chevron-right"></i>',
            removeSelected: '<i class="fa fa-chevron-left"></i>',
            removeAll: '<i class="fa fa-backward"></i>'
        }
    });
});
