@if($contract->template)
    @php
        ...
        $contractData = $contract->template->getContractData($employee, [
        ...
        switch ($contract->template->contract_type) {
            case 'Regular':
    ...
    @include($templateView, ['contractData' => $contractData])
@else
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        ...
        <title>Contract - {{ $contract->user->personalInformation->first_name ?? '' }}
            {{ $contract->user->personalInformation->last_name ?? '' }}
        </title>
        <style>
            body {
    ...
    <body>
        ...
        <!-- Display text content for non-template contracts -->
