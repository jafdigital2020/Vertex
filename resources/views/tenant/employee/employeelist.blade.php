                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="editEmploymentAction" name="employment_state" class="form-select select2"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $('#editEmploymentAction').val(emp.employment_detail.employment_state).trigger('change');
