                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">
                                                    <div class="d-flex align-items-center justify-content-center avatar avatar-xxl rounded-circle border border-dashed me-2 flex-shrink-0 text-dark frames">
                                                        <img id="previewImage" alt="Profile Image" class="rounded-circle" src="{{ URL::asset('build/img/users/user-13.jpg') }}">
                                                    </div>
                                                    <div class="profile-upload">
                                                        ...
                                                        <div class="profile-uploader d-flex align-items-center">
                                                            <div class="drag-upload-btn btn btn-sm btn-primary me-2">
                                                                Upload
                                                                <input type="file" name="profile_picture" id="profileImageInput" class="form-control image-sign" accept="image/*" onchange="previewSelectedImageAdd(event)">
                                                            </div>
                                                            <a href="javascript:void(0);" id="cancelImageBtn" class="btn btn-light btn-sm">Cancel</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label">Joining Date <span class="text-danger"> *</span></label>
                                                        <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="date_hired" id="dateHired">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3 ">
                                                    ...
                                                    <div class="pass-group">
                                                        <input type="password" class="pass-inputs form-control" name="confirm_password" id="confirmPassword">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="addBranchId" name="branch_id" class="form-select select2" oninput="autoFilterBranch('addBranchId','add_departmentSelect','add_designationSelect',false)"  placeholder="Select Branch">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="add_departmentSelect" name="department_id" class="form-select select2" oninput="autoFilterDepartment('add_departmentSelect','addBranchId','add_designationSelect',false)" placeholder="Select Department">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="add_designationSelect" name="designation_id" class="form-select select2" oninput="autoFilterDesignation('add_designationSelect','addBranchId','add_departmentSelect',false)"  placeholder="Select Designation">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="employmentStatus" name="employment_status" class="form-select select2" placeholder="Select Status">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="employmentType" name="employment_type" class="form-select select2" placeholder="Select Type">
                                ...
                                <div class="modal-body pb-0 ">
                                    <div class="row">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">
                                                ...
                                                <div class="profile-upload">
                                                    ...
                                                    <div class="profile-uploader d-flex align-items-center">
                                                        <div class="drag-upload-btn btn btn-sm btn-primary me-2">
                                                            Upload
                                                            <input type="file" name="profile_picture" id="editProfileImageInput" class="form-control image-sign" accept="image/*" onchange="previewSelectedImage(event)">
                                                        </div>
                                                        <a href="javascript:void(0);" id="editCancelImageBtn" class="btn btn-light btn-sm">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Employee ID <span class="text-danger"> *</span></label>
                                                <input type="text" class="form-control" name="employee_id" id="editEmployeeId">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        	<div class="mb-3">
                                                <label class="form-label">Joining Date <span class="text-danger"> *</span></label>
                                                <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="date_hired" id="editDateHired">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 ">
                                                ...
                                                <div class="pass-group">
                                                    <input type="password" class="pass-input form-control" name="password" id="editPassword">
                                                    <span class="ti toggle-password ti-eye-off"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3 ">
                                                ...
                                                <div class="pass-group">
                                                    <input type="password" class="pass-inputs form-control" name="confirm_password" id="editConfirmPassword">
                                                    <span class="ti toggle-passwords ti-eye-off"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Role<span class="text-danger"> *</span></label>
                                               <select name="role_id" id="editRoleId" class="form-select select2" placeholder="Select Role">
                                                <option value="" disabled selected>Select Role</option>
                                                    @foreach ($roles as $role )
                                                           <option value="{{ $role->id }}">{{ $role->role_name }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="editBranchId" name="branch_id" class="form-select select2" oninput="autoFilterBranch('editBranchId','editDepartmentSelect','editDesignationSelect',false)" placeholder="Select Branch">
                                                    <option value="" disabled selected>Select Branch</option>
                                                        @foreach ($branches as $branch)
                                                            <option value="{{ $branch->id }}">{{ $branch->name }}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="editDepartmentSelect" name="department_id" class="form-select select2" oninput="autoFilterDepartment('editDepartmentSelect','editBranchId','editDesignationSelect',false)" placeholder="Select Department">
                                                    <option value="" disabled selected>Select Department</option>
                                                    @foreach ($departments as $department)
                                                        <option value="{{ $department->id }}">{{ $department->department_name }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="editDesignationSelect" name="designation_id" class="form-select select2"  oninput="autoFilterDesignation('editDesignationSelect','editBranchId','editDepartmentSelect',false)" placeholder="Select Designation">
                                                    <option value="" disabled selected>Select Designation</option>
                                                        @foreach ($designations as $designation)
                                                            <option value="{{ $designation->id }}">{{ $designation->designation_name }}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="editEmploymentStatus" name="employment_status" class="form-select select2" placeholder="Select Status">
                                                    <option value="" disabled selected>Select Status</option>
                                                    <option value="Probationary">Probationary</option>
                                                    <option value="Regular">Regular</option>
                                                    <option value="Project-Based">Project Based</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select id="editEmploymentType" name="employment_type" class="form-select select2" placeholder="Select Type">
                                                    <option value="" disabled selected>Select Type</option>
                                                    <option value="Full-Time">Full-Time</option>
                                                    <option value="Part-Time">Part-time</option>
                                                    <option value="Freelancer">Freelancer</option>
            ...
            <div class="modal-content">
             <form id="deleteEmployeeForm" enctype="multipart/form-data" onsubmit="deleteID()">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="mb-3">
                        Are you sure you want to delete <strong><span id="employeeNamePlaceholder">this employee</span></strong>? This can’t be undone.
                    </p>
        ...
        <div class="modal-content">
            <form id="deactivateEmployeeForm" enctype="multipart/form-data">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="mb-3">
                        Are you sure you want to deactivate <strong><span id="deactivateEmployeeName">this employee</span></strong>?
                    </p>
                    <div class="d-flex justify-content-center">
                        <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-danger" id="confirmDeactivateBtn">Yes, Deactivate</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="mb-3">
                        Are you sure you want to activate <strong><span id="activateEmployeeName">this employee</span></strong>?
                    </p>
                    <div class="d-flex justify-content-center">
                         <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</button>
