                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                @else
                                                                    <div class="text-center py-4">
                                                                        ...
                                                                        <p class="text-muted mt-3">No leave credits assigned to this employee.</p>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="card-header">
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    ...
                                                                    <div class="d-flex gap-2">
                                                                        <select class="select2 form-select" id="employeeLeaveRecordsFilter" style="width: 200px;">
                                                                ...
                                                                <div class="row mt-3" id="employeeCustomDateRange" style="display: none;">
                                                                    <div class="col-md-6">
                                                                        <label class="form-label">From Date</label>
                                                                        <input type="date" class="form-control form-control-sm" id="employeeFromDate">
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label class="form-label">To Date</label>
                                                                        <input type="date" class="form-control form-control-sm" id="employeeToDate">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-body p-0">
                                                                <div class="custom-datatable-filter table-responsive">
                                                                    <table class="table datatable-filtered" id="employee_leave_records_table">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="d-flex align-items-center">
                        <h4 class="modal-title me-2">Edit Employee</h4><span>Employee ID :
                            {{ $users->employmentDetail->employee_id ?? 'N/A' }}</span>
                    </div>
                        ...
                        <ul class="nav nav-underline" id="myTab2" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="info-tab3" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">Employee Information</button>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img id="detailsPreviewImage"
                                                    src="{{ asset('storage/' . ($users->personalInformation->profile_picture ?? 'user-13.png')) }}"
                                                ...
                                                <div class="profile-uploader d-flex align-items-center">
                                                    <div class="drag-upload-btn btn btn-sm btn-primary me-2">
                                                        ...
                                                        <input type="file" name="profile_picture"
                                                            id="detailsProfileImageInput" class="form-control image-sign"
                                                            multiple="" accept="image/*"
                                                            onchange="previewDetailsSelectedImage(event)">
                                                    </div>
                                                    <a href="javascript:void(0);" id="detailsCancelImageBtn"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" placeholder="dd/mm/yyyy"
                                                name="date_hired" id="detailsDateHired">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3 ">
                                            ...
                                            <div class="pass-group">
                                                <input type="password" class="pass-inputs form-control"
                                                    name="confirm_password" id="detailsConfirmPassword">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="role_id" id="detailsRoleId" class="form-select select2"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select id="detailsBranchId" name="branch_id" class="form-select select2"
                                                oninput="autoFilterBranch('detailsBranchId','detailsDepartmentId','detailsDesignationId',false)"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Department<span class="text-danger">
                                                    *</span></label>
                                            <select id="detailsDepartmentId" name="department_id"
                                                class="form-select select2"
                                                oninput="autoFilterDepartment('detailsDepartmentId','detailsBranchId','detailsDesignationId',false)"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Designation<span class="text-danger">
                                                    *</span></label>
                                            <select id="detailsDesignationId" name="designation_id"
                                                class="form-select select2"
                                                oninput="autoFilterDesignation('detailsDesignationId','detailsBranchId','detailsDepartmentId',false)"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Employment Status<span class="text-danger">
                                                    *</span></label>
                                            <select id="detailsEmploymentStatus" name="employment_status"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            let employeeLeaveRecordsTable;
            
            // Initialize Select2 for filter dropdown
            $('#employeeLeaveRecordsFilter').select2({
            ...
            if ($('#employee_leave_records_table').length && $('#employee_leave_records_table tbody tr').length > 0) {
                employeeLeaveRecordsTable = initFilteredDataTable('#employee_leave_records_table', {
                    pageLength: 10,
            ...
            function filterTableByDate(startDate, endDate) {
                if (!employeeLeaveRecordsTable) return;

                employeeLeaveRecordsTable.rows().every(function() {
                    const row = this.node();
                ...
                employeeLeaveRecordsTable.draw();
            }

            // Filter dropdown change handler
            $('#employeeLeaveRecordsFilter').on('change', function() {
                const filterValue = $(this).val();
                
                if (filterValue === 'custom') {
                    $('#employeeCustomDateRange').show();
                } else {
                    $('#employeeCustomDateRange').hide();
                    
                    if (filterValue === '') {
                        // Show all records
                        if (employeeLeaveRecordsTable) {
                            employeeLeaveRecordsTable.rows().every(function() {
                                $(this.node()).show();
                            });
                            employeeLeaveRecordsTable.draw();
            ...
            $('#employeeFromDate, #employeeToDate').on('change', function() {
                const fromDate = $('#employeeFromDate').val();
                const toDate = $('#employeeToDate').val();
