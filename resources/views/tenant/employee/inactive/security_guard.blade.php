<?php $page = 'inactive-security-guards'; ?>
        ...
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                <div class="my-auto mb-2">
                    <h2 class="mb-1">Inactive Security Guards</h2>
                    <nav>
            ...
            <div class="payroll-btns mb-3">
                <a href="{{ route('inactive-employees') }}" class="btn btn-white  border me-2">Head Office</a>
                <a href="{{ route('inactive-security-guards') }}" class="btn btn-white active border me-2">Security Guard</a>
            </div>
