...
<head>
    ...
    <title>Contract for Probationary Employment</title>
...
<body>
    ...
    <div class="contract-page">
        <div class="contract-header">
            <div class="logo-container">
                ...
                <div class="header-center">
                    ...
                    <div class="contract-title">CONTRACT FOR PROBATIONARY EMPLOYMENT</div>
        ...
        <div class="contract-body">
            This Contract of Employment is made and executed at Quezon City on this <span
                class="variable-placeholder">{{ $contractData['start_date'] ?? 'DATE' }}</span> by and between:
        </div>

        <div class="party-section">
            <span class="employer-name">THEOS HELIOS SECURITY AGENCY CORPORATION</span>, a registered corporation duly
            ...
            (C5), Bagumbayan, Quezon City, and herein represented by its President, Alexis Alberi P. Torio, and herein
            after referred to as "EMPLOYER";
        </div>

        <div class="centered-text">And</div>
        ...
        <div class="centered-text">WITNESSETH:</div>
        ...
        <div class="party-section">
            This contract shall be valid and effective for six (6) months, commencing on <span
                class="variable-placeholder">{{ $contractData['start_date'] ?? 'DATE' }}</span> and automatically
            expiring on <span class="variable-placeholder">{{ $contractData['end_date'] ?? 'END DATE' }}</span>, with or
            without notice, unless renewed in writing as permanent or regular employee. Renewal of this probationary
            contract is the exclusive prerogative of the Employer depending on the need therefor and work performance of
            the EMPLOYEE;
        </div>

        <div class="party-section">
            Since the EMPLOYER had invested so much efforts to train the subject EMPLOYEE during said periods, the
            latter hereby categorically undertakes to complete at least six (6) months of employment with the Company
            and commits self not to resign earlier than the six month-contractual period which shall be reckoned from
            the date of permanency until <span
                class="variable-placeholder">{{ $contractData['end_date'] ?? 'END DATE' }}</span>. Failure to comply
            herewith shall render the EMPLOYEE liable for liquidated damages in favor of the EMPLOYER in the amount of
            IN PESOS : ONE HUNDRED THOUSAND (P100,000.00).
        </div>

        <div class="party-section">
            Any requirement to report beginning a specific date earlier than the commencement date for purposes of
            training and orientation are excluded from this employment contract and shall not be deemed compensable.
            Reporting to office beyond expiration date for purposes of processing exit clearance and making a turnover
            of duties and responsibilities are likewise excluded from this employment contract and shall not be deemed
            compensable. These periods are therefore neither considered as extension of employment nor renewal thereof;
        </div>

        <div class="contract-body no-indent" style="margin-top: 20px;">
            <strong>RESPONSIBILITY, JOB FUNCTIONS, COMPANY POLICY AND STANDARD</strong>
        </div>

        <div class="party-section">
            The EMPLOYEE agrees to perform with utmost diligence, responsibility and accountability all the duties and
            responsibilities indicated in his/her JOB DESCRIPTION attached herewith as ANNEX "A", together with such
            other duties and functions germane thereto and as may be assigned, from time to time, by the EMPLOYER. These
            shall serve as PERMANENCY STANDARDS of the EMPLOYER where the EMPLOYEE should garner a VERY SATISFACTORY
            evaluation or assessment from peers, superiors and administrators.
        </div>

        <div class="party-section">
            The EMPLOYEE hereby fully agrees and commits herself/himself to comply with all the company rules and
    ...
    <div class="contract-page" style="page-break-before: always;">
        ...
        <div class="party-section">
            The employee fully understands that the THSAC administrators, officers, and partners need all these material
    ...
    <div class="contract-page" style="page-break-before: always;">
        ...
        <div class="party-section">
            ...
            incentives, shall be released after the employee has fulfilled its obligations to the company, any losses
            and/or penalties incurred by the company due to the negligence of the EMPLOYEE shall be deducted to the last
            pay of EMPLOYEE;
        </div>
