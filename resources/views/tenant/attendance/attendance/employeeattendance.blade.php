                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between p-3">
                                    <!-- LEFT TEXT SECTION -->
                                    <div>
                                        <h6 class="fw-medium text-gray-5 mb-1" style="font-size: 14px;">Total Hours Week</h6>
                                        <h3 class="mb-1 fw-bold mt-4"
                                            style="line-height: 1; font-size: 20px; color: #212529;">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between p-3">
                                    <!-- LEFT TEXT SECTION -->
                                    <div>
                                        <h6 class="fw-medium text-gray-5 mb-1" style="font-size: 14px;">Total Hours Month</h6>
                                        <h3 class="mb-1 fw-bold mt-4"
                                            style="line-height: 1; font-size: 20px; color: #212529;">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between p-3">
                                    <!-- LEFT TEXT SECTION -->
                                    <div>
                                        <h6 class="fw-medium text-gray-5 mb-1" style="font-size: 14px;">Night Diff This Month</h6>
                                        <h3 class="mb-1 fw-bold mt-4"
                                            style="line-height: 1; font-size: 20px; color: #212529;">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between p-3">
                                    <!-- LEFT TEXT SECTION -->
                                    <div>
                                        <h6 class="fw-medium text-gray-5 mb-1" style="font-size: 14px;">Late This Month</h6>
                                        <h3 class="mb-1 fw-bold mt-4"
                                            style="line-height: 1; font-size: 20px; color: #212529;">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between p-3">
                                    <!-- LEFT TEXT SECTION -->
                                    <div>
                                        <h6 class="fw-medium text-gray-5 mb-1" style="font-size: 14px;">Undertime This Month</h6>
                                        <h3 class="mb-1 fw-bold mt-4"
                                            style="line-height: 1; font-size: 20px; color: #212529;">
