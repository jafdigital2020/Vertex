                                        ...
                                        <td>
                                            @if (
                                                ...
                                                <div class="btn-group" style="position: static; overflow: visible;">
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-primary dropdown-toggle"
                                                        data-bs-toggle="dropdown" title="View Location"
                                                ...
                                                <div class="action-icon d-inline-flex">
                                                    @if (in_array('Update', $permission))
                                                        <a href="#" class="me-2" data-bs-toggle="modal"
                                                            ...
                                                            data-status="{{ $userAtt->status }}"
                                                            data-is-rest-day="{{ $userAtt->is_rest_day ? '1' : '0' }}"><i
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.addEventListener("click", function(e) {
                if (e.target.closest('[data-bs-target="#edit_attendance"]')) {
                    ...
                    const isRestDay = btn.dataset.isRestDay;
                    ...
                    const restDaySwitch = document.getElementById("isRestDaySwitch");
                    restDaySwitch.checked = isRestDay === '1' || isRestDay === 'true';
                }
            });
            ...
            document.getElementById("updateAttendanceBtn").addEventListener("click", async function(e) {
                ...
                const isRestDay = document.getElementById("isRestDaySwitch").checked;
                ...
                try {
                    ...
                    if (!response.ok) {
                        ...
                        if (response.status === 403) {
                            ...
                            errorMessage =
                                'Please use Excel export for large datasets, or filter your data to fewer records.';
                        }
                    ...
                    if (blob.size === 0) {
                        throw new Error(
                            'The exported file is empty. No data available for the selected filters.'
                        );
                    }
