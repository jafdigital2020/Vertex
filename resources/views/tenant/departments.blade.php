...
@push('scripts')
    ...
    <script>
        $(document).on('click', '[data-bs-target="#edit_department"]', function() {
            ...
            $('#edit_department select[name="head_of_department"]').val(button.data('department_head')).trigger(
                'change');
            ...
            $.ajax({
                ...
                const rows = response.data.map(dep => {
                    ...
                    const statusBadge = isActive
                        ...
                        if (response.permission.includes('Update') || response.permission.includes(
                                'Delete')) {
