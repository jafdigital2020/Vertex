                                                    ...
                                                    <div class="action-icon d-inline-flex">
                                                        @if (in_array('Update', $permission))
                                                            <a href="#" class="me-2 edit-payroll-btn"
                                                                ...
                                                                data-earnings="{{ htmlspecialchars(json_encode($payroll->earnings), ENT_QUOTES, 'UTF-8') }}"
                                                                data-total-earnings="{{ $payroll->total_earnings }}"
                                                                data-allowance="{{ htmlspecialchars(json_encode($payroll->allowance), ENT_QUOTES, 'UTF-8') }}"
                                                                data-taxable-income="{{ $payroll->taxable_income }}"
                                                                data-deminimis="{{ htmlspecialchars(json_encode($payroll->deminimis), ENT_QUOTES, 'UTF-8') }}"
                                                                ...
                                                                data-deductions="{{ htmlspecialchars(json_encode($payroll->deductions), ENT_QUOTES, 'UTF-8') }}"
