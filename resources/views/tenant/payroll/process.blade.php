...
@section('content')
                                    ...
                                    <div class="col-xl-5">
                                        <div class="border-end pe-xl-4">
                                            ...
                                            <div class="manual-assigning" style="display: none;">
                                                ...
                                                <div class="mb-3">
                                                    <label for="payrollProcessBranchId" class="form-label fw-medium">Branch
                                                        <span class="text-danger">*</span></label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="payrollProcessUserId" class="form-label fw-medium">Employee
                                                        <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-xl-3">
                                        ...
                                        <div class="mb-4">
                                            <label class="form-label fw-medium d-block mb-2">Pag-IBIG Contribution <span
                                                    class="text-danger">*</span></label>
                                            <div class="btn-group w-100" role="group">
                                                <input type="radio" class="btn-check" name="pagibig_option" id="pagibigYes"
                                                    value="yes" required>
                                                <label class="btn btn-outline-secondary" for="pagibigYes">Half</label>

                                                <input type="radio" class="btn-check" name="pagibig_option" id="pagibigNo"
                                                    value="no" required>
                                                <label class="btn btn-outline-secondary" for="pagibigNo">None</label>

                                                <input type="radio" class="btn-check" name="pagibig_option" id="pagibigFull"
                                                    value="full" required>
                                        ...
                                        <div class="mb-4 pb-3 border-bottom">
                                            <label class="form-label fw-medium d-block mb-2">Cut-off Period <span
                                                    class="text-danger">*</span></label>
                                            <div class="btn-group w-100" role="group">
                                                <input type="radio" class="btn-check" name="cutoff_period" id="cutoffOne"
                                                    value="1" required>
                                                <label class="btn btn-outline-secondary" for="cutoffOne">1st Half</label>

                                                <input type="radio" class="btn-check" name="cutoff_period" id="cutoffTwo"
                                                    value="2" required>
                                        ...
                                        @if (in_array('Create', $permission))
                                            <div class="d-grid gap-2">
                                                <button type="submit" class="btn btn-primary btn-lg py-3" id="processPayrollBtn"
                                                    disabled>
                                                    <!-- Default State -->
                                                    <span class="btn-text">
                ...
                <div class="card mt-4">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                        ...
                        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                            <!-- Bulk Actions Dropdown -->
                            <div class="dropdown me-2">
                                <button class="btn btn-outline-primary dropdown-toggle" type="button" id="bulk13thMonthActions"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    Bulk Actions
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="bulk13thMonthActions">
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0);" id="bulkGenerate13thMonthPayslip">
                                            <i class="ti ti-file-invoice me-1"></i>Generate Payslip
                                        </a>
                                    </li>
                                    <li>
                                ...
                                <tbody id="thirteenthMonthTableBody">
                                    @foreach ($thirteenthMonthPayrolls as $thirteenthMonth)
                                        <tr>
                                            <td>
                                                <div class="form-check form-check-md">
                                                    <input class="form-check-input thirteenth-month-checkbox" type="checkbox"
                                                        value="{{ $thirteenthMonth->id }}">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge badge-soft-secondary">{{ $thirteenthMonth->status }}</span>
                                                @endif
                                            </td>
                                            <td>
                                                @if (in_array('Update', $permission) || in_array('Delete', $permission))
                                                    <div class="action-icon d-inline-flex">
                                                        @if (in_array('Update', $permission))
                                                            <a href="#" class="me-2 view-13th-month-btn" data-bs-toggle="modal"
                                                                data-bs-target="#view_13th_month" data-id="{{ $thirteenthMonth->id }}"
                                                        ...
                                                        @endif
                                                        @if (in_array('Delete', $permission))
                                                            <a href="javascript:void(0);" class="btn-delete-13th" data-bs-toggle="modal"
                                                                data-bs-target="#delete_13th_month" data-id="{{ $thirteenthMonth->id }}"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        <label for="payroll_period_start" class="form-label fw-semibold">Period
                                            Start</label>
                                        <input type="date" class="form-control form-control-sm" id="payroll_period_start"
                                            name="payroll_period_start">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="payroll_period_end" class="form-label fw-semibold">Period End</label>
                                        <input type="date" class="form-control form-control-sm" id="payroll_period_end"
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" class="form-control form-control-sm" id="total_late_minutes"
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text bg-light">₱</span>
                                            <input type="number" class="form-control text-end" id="night_differential_pay"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" class="form-control text-end"
                                                id="overtime_night_differential_pay" name="overtime_night_differential_pay"
                                                step="0.01">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text bg-light">₱</span>
                                            <input type="number" class="form-control text-end" id="philhealth_contribution"
    ...
    <div class="modal fade" id="view_13th_month" tabindex="-1" aria-labelledby="view13thMonthLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary text-white">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="modal-title fw-bold mb-0 text-white" id="thirteenthMonthExportModalLabel">Export 13th
                                Month
                                Pay</h5>
