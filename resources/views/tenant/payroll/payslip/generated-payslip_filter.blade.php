        ...
        <tr>
            ...
            <td>
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-2">
                        ...
                        <span class="fs-12">{{ $payslip->user->employmentDetail->department->department_name }}</span>
                    </div>
                </div>
            </td>
            ...
            <td class="text-center">
                <div class="action-icon d-inline-flex">
                    <a href="{{ route('generatedPayslips', $payslip->id) }}" class="me-2 edit-payroll-btn"
                        title="View Payslip">
                        <i class="ti ti-eye"></i>
                    </a>
                    @if (in_array('Update', $permission))
                        <a href="#" class="me-2 edit-payroll-btn" data-bs-toggle="modal"
                            data-bs-target="#edit_payroll" title="Edit/Rollback"><i class="ti ti-repeat"></i></a>
                    @endif
                    @if (in_array('Delete', $permission))
                        <a href="javascript:void(0);" class="btn-delete" data-bs-toggle="modal"
                            data-bs-target="#delete_payroll" title="Delete"><i class="ti ti-trash"></i></a>
                    @endif
                </div>
            </td>
        </tr>
