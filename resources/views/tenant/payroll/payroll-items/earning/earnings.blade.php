        ...
        <div class="content">
            ...
            <div class="d-flex flex-wrap gy-2 justify-content-between my-4">
                <div class="payroll-btns">
                    ...
                    <a href="{{ route('earnings') }}" class="btn btn-white active border">Earnings</a>
                            ...
                            <tbody>
                                @foreach ($earningTypes as $earning)
                                    <tr>
                                        ...
                                        <td>{{ ucfirst($earning->calculation_method) }}</td>
                                        <td>{{ number_format($earning->default_amount, 2) }}</td>
                                        <td>{{ $earning->is_taxable ? 'Yes' : 'No' }}</td>
                                        <td>{{ $earning->creator_name }}</td>
                                        <td>{{ $earning->updater_name }}</td>
                                        <td>
