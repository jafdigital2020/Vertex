                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap me-2">
                                    <a href="https://www.sss.gov.ph/" target="_blank"
                                        ...
                                        <span
                                            ...
                                            <img src="{{ asset('build/img/sss-logo.png') }}" alt="SSS Logo" style="width:22px;height:22px;">
                                        </span>
                                    ...
                                    <a href="https://www.philhealth.gov.ph/" target="_blank"
                                        ...
                                        <span
                                            class="bg-white rounded-circle d-flex align-items-center justify-content-center me-2"
                                            style="width:28px;height:28px;">
                                            <img src="{{ asset('build/img/philhealth.jpeg') }}" alt="PhilHealth Logo" style="width:22px;height:22px;">
                                        </span>
                                    ...
                                    <a href="https://www.pagibigfund.gov.ph/" target="_blank"
                                        ...
                                        <span
                                            class="bg-white rounded-circle d-flex align-items-center justify-content-center me-2"
                                            style="width:28px;height:28px;">
                                            <img src="{{ asset('build/img/pag-ibig.png') }}" alt="Pag-IBIG Logo" style="width:22px;height:22px;">
                                        </span>
                                    ...
                                    <a href="https://www.bir.gov.ph/" target="_blank"
                                        ...
                                        <span
                                            class="bg-white rounded-circle d-flex align-items-center justify-content-center me-2"
                                            style="width:28px;height:28px;">
                                            <img src="{{ asset('build/img/BIR.png') }}" alt="BIR Logo" style="width:22px;height:22px;">
                                        </span>
                                ...
                                @foreach ($sssContributions as $contribution)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ number_format($contribution->monthly_salary_credit, 2) }}</td>
                                        <td class="text-center">{{ number_format($contribution->employer_regular_ss, 2) }}
                                        </td>
                                        ...
                                        <td class="text-center">{{ number_format($contribution->employee_regular_ss, 2) }}
                                        </td>
                                        ...
                                        <td class="text-center">{{ number_format($contribution->total_contribution, 2) }}
                                        </td>
