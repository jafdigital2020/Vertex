        ...
        <div class="content">
            ...
            <div class="welcome-wrap mb-4">
                <div class=" d-flex align-items-center justify-content-between flex-wrap">
                    <div class="mb-3">
                        <h2 class="mb-1 text-white">Welcome Back, Super Admin</h2>
                        <p class="text-light">14 New Companies Subscribed Today !!!</p>
                    </div>
                    <div class="d-flex align-items-center flex-wrap mb-1">
                        <a href="{{ route('superadmin-tenants') }}" class="btn btn-dark btn-md me-2 mb-2">Tenants</a>
                        <a href="{{ route('superadmin-packagetable') }}" class="btn btn-light btn-md mb-2">All Packages</a>
                    </div>
                </div>
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <a href="javscript:void(0);"
                                        class="avatar avatar-md bg-gray-100 rounded-circle flex-shrink-0">
                        ...
                        <div class="card-body pb-2">
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <a href="javscript:void(0);"
                                        class="avatar avatar-md bg-gray-100 rounded-circle flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/company-icon-11.svg') }}"
                                            class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <a href="javscript:void(0);"
                                        class="avatar avatar-md bg-gray-100 rounded-circle flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/company-icon-12.svg') }}"
                                            class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <a href="javscript:void(0);"
                                        class="avatar avatar-md bg-gray-100 rounded-circle flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/company-icon-13.svg') }}"
                                            class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex justify-content-between flex-wrap mb-1">
                                <div class="d-flex align-items-center mb-2">
                                    <a href="javscript:void(0);"
                                        class="avatar avatar-md bg-gray-100 rounded-circle flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/company-icon-15.svg') }}"
                                            class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
