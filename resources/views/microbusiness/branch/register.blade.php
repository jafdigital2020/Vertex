                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="card mb-4">
                                                            <div class="card-body">
                                                                ...
                                                                @php
    $features = [
        'Employee Official Business' => 1200,
        'Asset Management Tracking' => 1900,
        'Bank Data Export (CSV)' => 1000,
        'Payroll Batch Processing' => 600,
        'Policy Upload' => 500,
        'Custom Holiday' => 800,
    ];
                                                                @endphp
                                                                ...
                                                                @foreach ($features as $label => $price)
                                                                    @php $id = Str::slug($label); @endphp
                                                                    <div class="d-flex align-items-center justify-content-between p-3 mb-2 border rounded"
                                                                        style="border-color: #064857;">
                                                                        <div class="d-flex align-items-center">
                                                                            <input class="form-check-input me-2" type="checkbox"
                                                                                id="{{ $id }}" name="features[]" value="{{ $label }}"
                                                                                data-price="{{ $price }}">
                                                                            <div class="me-3">
                                                                                <!-- Icons for features -->
                                                                                @if ($label === 'Employee Official Business')
                                                                                    <i class="bi bi-briefcase"></i>
                                                                                @elseif ($label === 'Asset Management Tracking')
                                                                                    <i class="bi bi-hdd-network"></i>
                                                                                @elseif ($label === 'Bank Data Export (CSV)')
                                                                                    <i class="bi bi-file-earmark-spreadsheet"></i>
                                                                                @elseif ($label === 'Payroll Batch Processing')
                                                                                    <i class="bi bi-stack"></i>
                                                                                @elseif ($label === 'Policy Upload')
                                                                                    <i class="bi bi-upload"></i>
                                                                                @elseif ($label === 'Custom Holiday')
                                        ...
                                        <div class="wizard-step d-none" data-step="3" style="min-height:340px;">
                                            ...
                                            <div id="paymentSummary" class="mt-4">
                                                <h5 class="mb-3" style="color: #064857;">
                                                ...
                                                <ul class="list-group mb-2 shadow-sm">
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span id="summaryTotalEmployees">3 @ ₱49.00</span>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        <span><strong>Selected Features:</strong></span>
                                                        <span id="summarySelectedFeatures">₱1600.00</span>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        <span><strong>Subtotal:</strong></span>
                                                        <span id="summarySubtotal">₱1747.00</span>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        <span><strong>VAT (12%):</strong></span>
                                                        <span id="summaryVat">₱209.64</span>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center bg-light">
                                                        <span><strong>Total Amount:</strong></span>
                                                        <span id="summaryTotal" style="font-size: 1.2rem; color: #064857;"><strong>₱1956.64</strong></span>
                                                    </li>
                                                </ul>
                                                <small class="text-muted"><i class="bi bi-info-circle"></i> All amounts are monthly and inclusive of VAT.</small>
                                            </div>
                    ...
                    <script>
                        ...
                        $(function () {
                            ...
                            // Mirror "Continue" button in Step 1 to Next
                            $('#planContinueBtn').on('click', function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        if (response.status === 'success') {
                                            ...
                                            $('#addBranchForm').after(
                                                '<div class="alert alert-success mt-3">Branch saved successfully!</div>'
                                            );
                                            // reset wizard
                                            window.currentStep = 1;
                                            showStep(window.currentStep);
...
@push('scripts')
        <script>
         ...
         function computePricing() {
                ...
                // Features Calculation (sum data-price of checked features)
                let featuresMonthly = 0;
                const lines = [];
                $('input[name="features[]"]:checked').each(function () {
                    const name = $(this).val();
                    const price = parseFloat($(this).data('price')) || 0;
                    featuresMonthly += price;
                    lines.push(`<li>${name}: <strong>${formatPHP(price)}</strong>/mo</li>`);
                });
        ...
        <p><strong>Total Employees:</strong> ${totalEmployees} @ ₱49.00 = <strong>₱${employeesMonthly.toFixed(2)}</strong></p>
        <p><strong>Selected Features:</strong> <strong>₱${featuresMonthly.toFixed(2)}</strong></p>
        <p><strong>Subtotal:</strong> <strong>₱${subtotalMonthly.toFixed(2)}</strong></p>
        <p><strong>VAT (12%):</strong> <strong>₱${vatMonthly.toFixed(2)}</strong></p>
        <hr>
        <p><strong>Total Amount:</strong> <strong>₱${(subtotalMonthly + vatMonthly).toFixed(2)}</strong></p>
    `;

                // Update the #paymentSummary div with the payment summary HTML
                $('#paymentSummary').html(paymentSummaryHtml);
            }

            // Trigger computePricing on input changes
            $('#totalEmployees').on('input change', function () {
                computePricing();
            });
                ...
                $('#wizardNext').off('click').on('click', function () {
                    ...
                    if (currentStep < totalSteps) {
                        ...
                        if (currentStep === totalSteps) {
                            ...
                            // Populate the features in the confirmation breakdown
     ...
     $('#addBranchForm').on('submit', function (e) {
                    ...
                    // Append each selected feature to formData as an object (not just label)
                    $('input[name="features[]"]:checked').each(function () {
                        const featureLabel = $(this).val();
                        const featurePrice = $(this).data('price');

                        // Append the feature as an object with label and price
            ...
            $(document).ready(function () {
                $('#verifyReferralCode').on('click', function () {
                    ...
                    $.ajax({
                        url: '{{ route('verify.referral.code') }}', // Assuming this is your route to verify the referral code
                        type: 'POST',
                        data: {
                        ...
                        error: function (xhr) {
                            ...
                            $('#referralStatus').addClass('d-none');
                            $('#referralError').text(
                                'Invalid referral code. Please ask your affiliate for a valid code or try again.'
                            );
                        }
                    });
                });
