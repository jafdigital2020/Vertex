...
@section('content')
    ...
    <header class="w-full shadow-md border-b border-gray-200 bg-white">
        <div class="flex items-center justify-between px-4 sm:px-6 lg:px-16 xl:px-20 py-3">
            ...
            <div onclick="window.location.href = 'https://jafdigital.co'" class="cursor-pointer">
                <img src="https://jafdigital.co/wp-content/uploads/2023/05/JAF-New-logo-300x300.png" alt="JAF Digital"
                    class="h-8 w-auto">
            </div>

            <!-- Help link -->
            <div onclick="window.open('https://jafdigital.co/contact-us/')"
                class="text-xs sm:text-sm md:text-base text-gray-700 hover:underline cursor-pointer">
                Need Help?
            </div>
        </div>
    </header>
        ...
        <div class="w-full max-w-6xl">
            ...
            <div class="mb-4 sm:mb-8">
                <div class="flex items-center gap-2 sm:gap-3">
                    <div
                        class="w-8 h-8 sm:w-10 sm:h-10 bg-timora-teal rounded-lg flex items-center justify-center text-white font-semibold text-base sm:text-lg">
                        T</div>
                    <div>
            ...
            <div class="bg-white border border-gray-200 shadow-2xl rounded-lg">
                ...
                <div class="px-3 py-3 sm:px-6 sm:py-4 border-b border-gray-100">
                    <div class="flex items-center gap-2 sm:gap-3">
                        <div
                            class="w-7 h-7 sm:w-8 sm:h-8 bg-timora-teal rounded-lg flex items-center justify-center text-white text-xs sm:text-sm font-medium">
                ...
                <form id="registrationForm" method="POST" action="{{ route('affiliate-branch-register') }}">
                        ...
                        <div class="p-3 sm:p-4">
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-5">
                                ...
                                <div class="lg:col-span-7 space-y-3 sm:space-y-4">
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-lg p-3 sm:p-4">
                                        <div
                                            ...
                                            <div>
                                                <div class="font-medium mb-1 text-timora-dark text-sm sm:text-base">Your
                                                    Subscription</div>
                                            ...
                                            <div class="text-left sm:text-right">
                                                ...
                                                <div class="text-xl sm:text-2xl font-semibold text-timora-teal"
                                                    id="monthlyTotal">₱49</div>
                                                <div class="text-xs text-gray-400">VAT Inclusive</div>
                                            </div>
                                        </div>
                                        <div
                                            class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 text-sm bg-gray-50 p-3 rounded border border-gray-100">
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-lg p-3 sm:p-4">
                                        <div
                                            ...
                                            <h3 class="font-semibold text-timora-dark text-sm sm:text-base">Add-on Features
                                            </h3>
                                            <span
                                                class="text-xs font-medium px-2 py-1 rounded-full text-white bg-timora-yellow w-fit">Optional</span>
                                        </div>
                                        <div class="space-y-1.5" id="addonsList">
                                            <div class="text-center py-4">
                                                <div
                                                    class="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-timora-teal">
                                                </div>
                                ...
                                <div class="lg:col-span-5 space-y-3 sm:space-y-4">
                                    <!-- Included Features -->
                                    <div class="bg-white border border-gray-200 rounded-lg p-3 sm:p-4">
                                        <h3 class="font-semibold text-timora-dark mb-3 text-sm sm:text-base">Included
                                            Features</h3>
                                        <div class="space-y-2">
                                            <!-- Employee Access -->
                                            <div class="bg-gray-50 p-3 rounded-lg border-l-4 border-employee-red">
                                                <div class="text-xs font-medium mb-2 text-employee-red">Employee Access
                                                </div>
                                                <div class="space-y-1.5">
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                            class="w-1 h-1 rounded-full mt-1.5 flex-shrink-0 bg-employee-red">
                                                        </div>
                                                        <span class="text-xs text-gray-600 leading-tight">Time Keeping
                                                    ...
                                                    <div class="flex items-start gap-2">
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Payslip View &
                                                            Download</span>
                                                    </div>
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Attendance Photo
                                                            Capture</span>
                                                    </div>
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Leave and Overtime
                                                            Filing</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-gray-50 p-3 rounded-lg border-l-4 border-timora-orange">
                                                ...
                                                <div class="space-y-1.5">
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                            class="w-1 h-1 rounded-full mt-1.5 flex-shrink-0 bg-timora-orange">
                                                        </div>
                                                        <span class="text-xs text-gray-600 leading-tight">Government Report
                                                            Generator</span>
                                                    </div>
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Employee List
                                                            View</span>
                                                    </div>
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Payroll
                                                            Process</span>
                                                    </div>
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Create
                                                            Employee</span>
                                                    </div>
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Geotagging +
                                                    ...
                                                    <div class="flex items-start gap-2">
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Earnings &
                                                            Deductions</span>
                                                    </div>
                                                    <div class="flex items-start gap-2">
                                                        <div
                                                        ...
                                                        <span class="text-xs text-gray-600 leading-tight">Flexible Shift
                                                            Scheduling</span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Pricing Summary -->
                                    <div
                                        class="bg-gradient-to-r from-timora-dark to-timora-teal rounded-lg p-3 shadow-lg transform lg:-translate-y-1">
                                            ...
                                            <div class="border-t-2 border-gray-300 pt-2 mt-2">
                                                <div class="flex justify-between items-center">
                                                    ...
                                                    <div class="text-right">
                                                        <div class="text-xl font-semibold text-timora-yellow"
                                                            id="totalPrice">₱49</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!-- Footer Navigation -->
                            <div
                                class="mt-4 sm:mt-6 pt-3 sm:pt-5 border-t-2 flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                                <button type="button"
                                    class="w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-md bg-white text-gray-400 opacity-50 cursor-not-allowed"
                                    disabled id="prevBtn">
                                    ← Previous
                                </button>
                                <div class="flex items-center gap-2">
                                ...
                                <button type="button"
                                    class="w-full sm:w-auto text-white hover:opacity-90 shadow-lg px-6 sm:px-8 py-2 rounded-md transition-all bg-timora-orange"
                                    id="nextBtn">
                                    Next Step →
                                </button>
                            </div>
                    ...
                    <div class="wizard-step" data-step="2">
                        <div class="p-3 sm:p-4">
                            ...
                            <div
                                class="mb-3 p-3 rounded-lg border-l-4 border-timora-yellow border border-gray-200 bg-gray-50">
                                <label class="text-xs font-medium mb-2 block text-timora-yellow">Referral Code
                                    (Optional)</label>
                                <div class="flex flex-col sm:flex-row gap-2">
                                    ...
                                    <button type="button"
                                        class="text-white px-4 hover:opacity-90 h-9 text-sm rounded-md bg-timora-teal whitespace-nowrap"
                                        id="verifyBtn">
                                        Verify
                                    </button>
                                </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-5">
                                ...
                                <div class="lg:col-span-5">
                                    <div class="bg-white border border-gray-200 rounded-lg p-3 sm:p-4">
                                        <h3 class="font-semibold text-timora-dark mb-4 text-sm sm:text-base">User Details
                                        </h3>
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div
                                                    class="invalid-feedback hidden text-xs text-red-600 mt-1 flex items-center gap-1">
                                                    <span>⚠</span>
                                ...
                                <div class="lg:col-span-7 space-y-3">
                                    ...
                                    <div class="bg-white border border-gray-200 rounded-lg p-3 sm:p-4">
                                        <h3 class="font-semibold text-timora-dark mb-3 text-sm sm:text-base">Business
                                            Information</h3>
                            ...
                            <div
                                class="mt-4 sm:mt-6 pt-3 sm:pt-5 border-t-2 flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                                <button type="button"
                                    class="w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-md bg-white text-gray-700 hover:bg-gray-50 shadow-sm"
                                    id="prevBtn2">
                                    ← Previous
                                </button>
                                <div class="text-sm text-gray-500">Step 2 of 2</div>
                                <button type="submit"
                                    class="w-full sm:w-auto text-white px-6 sm:px-8 py-2 hover:opacity-90 shadow-lg transition-all rounded-md bg-timora-orange"
                                    id="submitBtn">
                                    Proceed to Payment
                                </button>
                                <button type="button"
                                    class="w-full sm:w-auto text-white px-6 sm:px-8 py-2 hover:opacity-90 shadow-lg transition-all rounded-md bg-timora-orange d-none"
                                    id="nextBtn2">
                                    Next Step →
                                </button>
                            </div>
    ...
    <footer class="bg-white border-t border-gray-200 text-gray-700">
        ...
        <div class="px-6 md:px-20 py-16 flex flex-col md:flex-row justify-between items-start gap-12">
            ...
            <div class="md:w-1/2 max-w-md">
                <div onclick="window.location.href='https://jafdigital.co/'" class="flex items-center mb-4 cursor-pointer">
                    <img src="https://jafdigital.co/wp-content/uploads/2023/05/JAF-New-logo-300x300.png" alt="OneJAF Logo"
                        class="h-8 w-auto">
                </div>
            ...
            <div class="flex flex-col sm:flex-row gap-32 text-sm">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="https://jafdigital.co/custom-software-development/"
                                class="hover:text-red-500 transition">
                                Custom Software Development
                            </a>
                        </li>
                        <li>
                            <a href="https://jafdigital.co/it-infrastructure-technical-support/"
                                class="hover:text-red-500 transition">
                                IT Infrastructure and Technical Support
                            </a>
                        </li>
                        <li>
                            <a href="https://jafdigital.co/digital-marketing-advertising-solutions/"
                                class="hover:text-red-500 transition">
                                Digital Marketing and Advertising Solutions
                            </a>
                        </li>
                        <li>
                            <a href="https://jafdigital.co/web-and-mobile-applications/"
                                class="hover:text-red-500 transition">
                                Web and Mobile Applications
                            </a>
                        </li>
                        <li>
                            <a href="https://jafdigital.co/system-integration-and-automation/"
                                class="hover:text-red-500 transition">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        ...
                        <li class="flex items-start">
                            <a href="https://www.google.com/maps/place/JAF+Digital/@14.5590245,121.019474,19z/data=!3m1!4b1!4m6!3m5!1s0x3397c9c1f6dfce91:0x43ec0af73b03fe22!8m2!3d14.5590245!4d121.019474!16s%2Fg%2F11n0pn3pzv?entry=ttu&g_ep=EgoyMDI1MDcyNy4wIKXMDSoASAFQAw%3D%3D"
                                target="_blank" rel="noopener noreferrer"
                                class="flex items-start hover:text-red-500 transition">
                    ...
                    <div class="flex space-x-4 mt-6 text-gray-500">
                        <a href="https://www.facebook.com/OneJAFCustomizableSystemDevelopment"
                            class="hover:text-red-500 transition">
        ...
        <!-- Bottom Bar -->
        <div
            class="border-t border-gray-200 py-6 px-6 md:px-20 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
