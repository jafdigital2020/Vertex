    ...
    public function run(): void
    {
        ...
        DB::table('addons')->insert([
            ...
            [
                ...
                'features' => json_encode([
                    [
                        'title' => 'Company-wide policy distribution',
                        'tooltip' => 'Share policies across the entire organization.'
                    ],
                    [
                        'title' => 'Policy version control',
                        'tooltip' => 'Track changes and maintain policy history.'
                    ],
                    [
                        'title' => 'Employee acknowledgment tracking',
                        'tooltip' => 'Monitor which employees have reviewed and acknowledged policies.'
                    ],
                    [
                        'title' => 'Policy templates',
                        'tooltip' => 'Use pre-built templates to create new policies quickly.'
                    ],
                    [
                        'title' => 'Automated notifications',
                        'tooltip' => 'Notify employees automatically when new policies are published.'
                    ]
                ]),
                'icon' => 'file-check',
                'created_at' => now(),
            ...
            [
                ...
                'features' => json_encode([
                    [
                        'title' => 'Unlimited approval levels',
                        'tooltip' => 'Add as many approval levels as needed for your workflow.'
                    ],
                    [
                        'title' => 'Multi-tier approval workflows',
                        'tooltip' => 'Create complex approval chains with multiple tiers.'
                    ],
                    [
                        'title' => 'Custom approval chains',
                        'tooltip' => 'Design approval processes tailored to your organization.'
                    ],
                    [
                        'title' => 'Conditional approval routing',
                        'tooltip' => 'Route approvals based on specific conditions or criteria.'
                    ],
                    [
                        'title' => 'Approval delegation',
                        'tooltip' => 'Allow approvers to delegate their approval authority.'
                    ]
                ]),
                'icon' => 'users-check',
                'created_at' => now(),
            ...
            [
                ...
                'features' => json_encode([
                    [
                        ...
                        'tooltip' => 'Track assets assigned to employees.'
                    ],
                    [
                        'title' => 'Asset settings configuration',
                        'tooltip' => 'Configure asset categories, types, and rules.'
                    ],
                    [
                        'title' => 'Complete asset lifecycle tracking',
                        'tooltip' => 'Monitor assets from acquisition to disposal.'
                    ],
                    [
                        'title' => 'Asset assignment & return',
                        'tooltip' => 'Manage the assignment and return of assets to employees.'
                    ],
                    [
                        'title' => 'Depreciation tracking',
                        'tooltip' => 'Track asset depreciation over time.'
                    ],
                    [
                        'title' => 'Maintenance scheduling',
                        'tooltip' => 'Schedule and track asset maintenance activities.'
                    ],
                    [
                        'title' => 'Asset audit reports',
                        'tooltip' => 'Generate comprehensive asset audit reports.'
                    ]
                ]),
                'icon' => 'box-check',
                'created_at' => now(),
