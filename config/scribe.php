...
// In production we install without dev dependencies, so bail out early if Scribe isn't present.
...
return [
    ...
    'routes' => [
        [
            ...
            'include' => [
                // Not needed - we're matching all api routes
            ],

            // Exclude these routes even if they matched the rules above.
            'exclude' => [
                // Add specific routes to exclude if needed
            ],
        ],
    ],
    ...
    'laravel' => [
        ...
        // Hide the endpoints tab in the documentation
        'show_endpoints_tab' => false,
    ],
