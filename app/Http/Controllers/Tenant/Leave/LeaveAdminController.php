...
class LeaveAdminController extends Controller
{
    ...
    private function logLeaveAdminError(
        string $errorType,
        string $message,
        Request $request,
     ...
     * }
     */
    public function deleteLeaveRequest(Request $request, $leaveRequestId)
    {
        ...
        try {
            ...
            $cleanMessage = "Server error while deleting leave request. Please try again later.";

            $this->logLeaveAdminError(
